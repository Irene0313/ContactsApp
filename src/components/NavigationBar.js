...
const pages = ['Contacts', 'Calendar', 'Save'];
...
function ResponsiveAppBar() {
    ...
    return (
        <AppBar position="sticky" sx={{ backgroundColor: '#15104D' }}>
            <Container maxWidth="xl">
                <Toolbar disableGutters>
                    ...
                    <Box sx={{ mr: 2 }}>
                        <IconButton size="X-large" aria-label="show 4 new notifications" color="inherit">
